                    ...
                    <div className="form-question-spacing">
                        ...
                        <div className="form-field-spacing">
                            ...
                            <textarea
                                ...
                                placeholder="Conte um pouco sobre sua trajetória, principais dificuldades e sonhos."
                ...
                <div className="section-card">
                    <div className="form-question-spacing">
                        <div className="grid grid-cols-1 md:grid-cols-2 form-grid-spacing">
                            ...
                            <div className="form-field-spacing">
                                <Label>Como seus responsáveis se sentiriam caso você ingressasse em uma faculdade pública em outro estado?</Label>
                        ...
                        <div className="form-field-spacing">
                            <Label>Como pretende organizar sua frequência na Educafro? Em quais dias poderá comparecer?</Label>
                            <Controller
